//! Subroutine images.
//!
//! Each [`Subroutine`][`crate::core::subroutine::entity::Entity`] running on the Holodekk is
//! backed by an "image" residing on disk.  These are currently just a directory containing the
...
pub mod fixtures {
    ...
    use crate::core::subroutine::Kind;
