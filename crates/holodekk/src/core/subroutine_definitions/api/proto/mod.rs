...
impl From<SubroutineDefinition> for entities::RpcSubroutineDefinition {
...
impl From<entities::RpcSubroutineDefinition> for SubroutineDefinition {
...
mod tests {
    ...
    fn converts_to_rpc_subroutine_definition_from_subroutine_definition() {
        ...
        let definition = SubroutineDefinition::new("test", "/tmp", SubroutineKind::Ruby);
