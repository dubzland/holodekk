...
use crate::core::scene::entity::Repository;
...
/// Store a new [`Entity`][`crate::core::scene::Entity`] in the repository.
pub mod create;
pub use create::Create;
/// Delete an existing [`Entity`][`crate::core::scene::Entity`] from the repository.
pub mod delete;
pub use delete::Delete;
/// Find one or more [`Entities`][`crate::core::scene::Entity`] in the repository.
pub mod find;
pub use find::Find;
/// Retrieve a single [`Entity`][`crate::core::scene::Entity`] from the repository.
pub mod get;
pub use get::Get;
